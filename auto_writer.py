...
COUPANG_BANNER = '''<div style="margin:28px 0;text-align:center;overflow:hidden;">
  <iframe src="https://ads-partners.coupang.com/widgets.html?id=976950&template=carousel&trackingCode=AF0866991&subId=&width=300&height=100&tsource=" style="max-width:100%;width:300px;height:100px;border:none;" scrolling="no" referrerpolicy="unsafe-url" browsingtopics></iframe>
</div>'''
