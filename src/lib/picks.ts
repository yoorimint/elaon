      ...
      items: [
        ...
        },
        {
          ...
          detailContent: {
            ...
            faq: [
              { q: "X 계정 필수?", a: "무료 사용 시 X 계정 권장. SuperGrok($30/월) 단독 구독은 X 계정 없이 grok.com 에서 가능." },
              { q: "ChatGPT 와 차이?", a: "ChatGPT 는 범용성·한국어 자연스러움 우위. Grok 은 X 실시간 데이터·검열 적음·유머/풍자 강점. 일반 업무·전문 작업은 ChatGPT, 시의성 정보·논쟁적 주제는 Grok 이 자연스러움." },
              { q: "한국 정치·사회 답변 신뢰?", a: "검열이 적어 답변이 직설적이지만, 사실 확인 없이 그대로 인용하는 건 위험. 중요한 결정·공식 자료엔 사실 확인 후 사용 권장." },
              { q: "이미지 생성도?", a: "Aurora 라는 자체 이미지 생성 기능 있음. Midjourney·DALL·E 보다는 약하지만 X 트윗 안에 첨부하기 좋은 빠른 시각 자료 생성에 사용." },
              { q: "DeepSearch 가 뭐?", a: "Perplexity 같은 검색 + 답변 종합 모드. X 실시간 트윗 + 일반 웹 검색을 종합해 답변. 최신 뉴스·이벤트 분석에 유용." },
              { q: "회사 자료 올려도?", a: "X 약관에 따라 데이터가 학습에 사용될 수 있음. 매우 민감한 자료는 SuperGrok 의 No-train 옵션 확인하거나 다른 챗봇 사용 권장." },
              { q: "한국 시장 정보 정확?", a: "글로벌·영어권 정보는 강하지만 한국 로컬 정보(한국 식당·국내 쇼핑몰·한국 정책) 는 CLOVA X·네이버 검색이 우위. 한국 IT·정치·연예계 트위터 트렌드는 Grok 강점." },
              { q: "Premium+ vs SuperGrok?", a: "X 를 메인 SNS 로 쓰면 X Premium+($16) 가 가성비 1티어. X 안 쓰면 SuperGrok($30) 단독. 광고 제거·긴 트윗·Grok 풀 사용 등을 한 번에 묶어 더 저렴." },
            ],
            relatedKeywords: [
              "Grok 한국 사용",
              "Grok 가격",
