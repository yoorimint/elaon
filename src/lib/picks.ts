...
const MONEY: PickCategory = {
  ...
  shortTitle: "정부지원금",
  emoji: "💰",
  oneLiner: "신청만으로 받는 정부·금융 공식 사이트 22곳.",
  description:
    "정부24, 보조금24, 복지로, 카드포인트 통합조회, 내보험 찾아줌, 휴면예금 찾아줌, 홈택스 등 신청만으로 받을 수 있는 정부·금융 공식 사이트 22곳을 카테고리별로 정리한 디렉토리입니다.",
  longIntro: [
    "정부24, 보조금24, 복지로, 카드포인트 통합조회 등 한국 정부·공공기관·금융결제원에서 운영하는 공식 사이트를 카테고리별로 모았습니다. 도메인은 모두 .go.kr 또는 .or.kr 로 끝납니다.",
    ...
    "청년 대상 정책은 온통청년(youthcenter.go.kr) 에서 통합 검색할 수 있습니다. 청년도약계좌, 청년월세 한시 특별지원, 국민취업지원제도 등이 포함됩니다.",
  ...
  faq: [
    ...
    {
      q: "휴면예금과 휴면보험금의 차이는 무엇인가요?",
      a: "휴면예금은 만기·해지 후 5년 이상, 휴면보험금은 만기·해지·실효 후 3년 이상 청구가 없는 자산입니다. 둘 다 sleepmoney.or.kr 에서 한 번에 조회 가능하며 환급 신청 후 본인 계좌로 입금됩니다. 사망자의 휴면자산은 상속인이 대리 청구할 수 있습니다.",
    },
    {
      q: "청년월세와 청년도약계좌는 어디에서 신청하나요?",
      a: "청년월세는 복지로(bokjiro.go.kr), 청년도약계좌는 취급 은행 앱·창구에서 신청합니다. 두 사업 모두 온통청년(youthcenter.go.kr) 에서 자격 진단과 신청 링크가 통합 안내됩니다. 청년도약계좌는 만 19~34세, 개인소득 7,500만원 이하 등의 자격 조건이 있습니다.",
    },
    {
