...
const AI: PickCategory = {
  slug: "ai",
  title: "AI 도구 추천 2026 — 무료로 쓰는 글쓰기·이미지·영상·코딩 30선",
  metaTitle: "AI 도구 추천 2026 — 무료 글쓰기·이미지·영상·코딩 30선",
  shortTitle: "AI 도구",
  emoji: "🤖",
  oneLiner: "한국에서 가입·결제·이용 다 되는 것만.",
  description:
    "ChatGPT, Claude, Gemini, Midjourney, Suno, Cursor 등 한국에서 바로 쓰는 AI 도구 30가지. 무료 한도, 한국어 품질, 결제 방법, 대안까지 정리.",
  longIntro: [
...
const MONEY: PickCategory = {
  slug: "money",
  title: "정부지원금·환급금 사이트 모음 — 숨은돈 찾는 22곳",
  metaTitle: "정부지원금·환급금 사이트 모음 — 숨은돈 찾는 22곳",
  shortTitle: "정부지원금",
  emoji: "💰",
      ...
      items: [
        {
          ...
          details:
            "생명·손해보험협회 공동 운영. 본인 명의 보험 가입 내역과 미수령 만기·중도·휴면 보험금 한 번에 조회. 부모님 사후 보험금 미신청 사례 많아 가족 단위로 확인 권장.",
          useCases: [
            "본인 보험 가입 현황 확인",
            "가족 사후 미수령 보험금 청구",
            "휴면 보험금 환급",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "됨. cardpoint.or.kr 에서 본인 인증 후 모든 카드사 포인트를 한 번에 본인 명의 계좌로 출금. 1원 단위까지 가능, 수수료 없음. 출금 후 1~3영업일 내 입금. 분기마다 한 번씩 점검 권장.",
    },
    {
...
const FREE: PickCategory = {
      ...
      items: [
        {
          ...
          details:
            "Getty Images 자회사. 500만+ 고화질 사진을 Unsplash 라이선스로 제공 — 상업·수정·배포 모두 자유, 저작자 표시 권장이지만 의무는 아님. 사진 품질이 스톡 사진 회사 수준으로 일관. AI 이미지가 늘면서 '실사 사진' 만 쓸 때 1순위.",
          useCases: [
            "블로그·웹사이트 헤더",
            "PPT 표지·섹션",
            "유튜브 썸네일 배경",
          ...
          pricing: "free",
          tip: "사진 속 인물 초상권·브랜드 로고는 별도 권리. 광고·홍보용 인물 사진은 모델 릴리스 있는 유료 스톡 권장.",
        ...
        },
        {
          ...
          details:
            "5~30초 짜리 시네마틱 영상을 Coverr 라이선스로 무료 제공(상업 OK, 표시 권장). 웹사이트 헤더 배경, 랜딩 페이지 영상으로 특화. 사진보다 영상이 필요할 때.",
          useCases: [
            "웹사이트 배경 영상",
            "랜딩 페이지 히어로",
            "프레젠테이션 도입 영상",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "사진 라이선스(상업 OK)와 인물 초상권은 별개. 사진가가 자유 라이선스로 풀었어도 모델 본인이 광고 허락 안 했으면 분쟁 가능. 인물 식별되는 사진을 광고·홍보에 쓸 땐 모델 릴리스 있는 유료 스톡(Getty·Shutterstock) 권장.",
    },
    {
    ...
    },
    {
      ...
      a: "사이트 라이선스는 허용하지만 AI 생성물의 저작권 인정 여부가 미국·EU·한국 모두 미정. 향후 법 개정으로 소급 적용 가능성 있음. AI 생성 명시 이미지는 광고·브랜드 자료 사용은 피하고, 본인이 직접 만든 AI 이미지(Midjourney 유료 등) 권장.",
    },
    {
...
const COIN: PickCategory = {
  slug: "coin",
  title: "코인·주식 무료 도구 모음 — 백테스트·차트·온체인·공시 22선",
  metaTitle: "코인·주식 무료 도구 모음 22선 — 백테스트·차트·온체인",
  shortTitle: "코인·주식",
  emoji: "📈",
  oneLiner: "트레이더가 매일 쓰는 무료 도구만.",
  description:
    "TradingView, 업비트, CoinGecko, DART, KRX, Glassnode, DefiLlama, 한경 컨센서스 등 한국 트레이더가 실제로 쓰는 코인·주식 차트·백테스트·온체인·공시 무료 도구 22곳.",
  longIntro: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: "절대 그대로 적용하면 위험. 백테스트는 슬리피지·체결지연·시장 충격을 완벽히 반영 못 한다. 본 사이트도 백테스트 결과에 10~20% 할인해서 실전 기대치 잡으라고 권장하며, 실전 진입 전 소액 모의·실전 비교를 한 달 이상 거치는 게 안전.",
    },
    {
    ...
    {
      q: "한경 컨센서스 리포트 믿을 만?",
      a: "리포트는 작성 시점 의견이고 증권사는 종목 거래하는 이해관계자라는 점을 항상 고려. 목표주가보다 실적 추정치·산업 분석·경쟁사 비교 같은 객관 데이터 활용 권장. 같은 종목 여러 증권사 리포트 교차 비교(컨센서스)가 단일 리포트보다 안전.",
    },
    {
